...
exports.forgotPassword = async (req,res,next) => {
    ...
    const sender = {
        email : 'kanha171@gmail.com',
        name : 'Kanhaiya'
        // email: 'swapnil.satpute132@gmail.com',
        // name: 'Swapnil'
    }
    const recievers = [
        {
    ...
    tranEmailApi.sendTransacEmail({
        ...
        htmlContent: `Click on the link below to reset password <br> <a href="http://localhost:4000/password/resetpassword/${id}">Reset password</a>`,
